...
# Location of your dstream-zeromq git development area
SPARK_HOME = os.environ.get("SPARK_DSTREAM_ZEROMQ_HOME", os.getcwd())
# Remote name which points to the Gihub site
PR_REMOTE_NAME = os.environ.get("PR_REMOTE_NAME", "origin")
# Remote name which points to Github site
...
GITHUB_BASE = "https://github.com/spark-packages/dstream-zeromq/pull"
GITHUB_API_BASE = "https://api.github.com/repos/spark-packages/dstream-zeromq"
